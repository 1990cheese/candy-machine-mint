...
const scripts = [
  ...
  {
    type: 'code',
    body: 'WebFont.load({google:{families:["Montserrat:100,100italic,200,200italic,300,300italic,400,400italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic","Chakra Petch:300,regular,500,600,700","Trirong:100,200,300,regular,500,600,700,800,900","Titillium Web:200,300,regular,600,700,900"]}});',
    isAsync: false,
  },
  {
    type: 'code',
